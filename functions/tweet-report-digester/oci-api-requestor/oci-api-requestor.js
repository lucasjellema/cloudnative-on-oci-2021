...
function signRequest(request, body = "") {
    ...
    const privateKeyPath = process.env.OCI_RESOURCE_PRINCIPAL_PRIVATE_PEM || process.env.PRIVATE_KEY_FILE    // the last one is set by OCI for resource principal enabled functions
